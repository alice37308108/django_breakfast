...
class Breakfast(models.Model):
    ...
    daytime_sleepiness = models.IntegerField(verbose_name='昼間の眠気',
    ...
    impressions_of_the_day = models.TextField(blank=True, verbose_name='今日の感想')
    ...
    def get_daytime_sleepiness(self):
        return '😪' * self.daytime_sleepiness
